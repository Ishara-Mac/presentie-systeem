...
import domain.Afmelding;
import domain.Rooster;
import domain.RoosterRegel;
...
public class AbsentiePopUpController {
    ...
    @FXML
    private TextArea redenTextArea;
    ...
    public static void setRegel(RoosterRegel regel){
        AbsentiePopUpController.regel = regel;}
